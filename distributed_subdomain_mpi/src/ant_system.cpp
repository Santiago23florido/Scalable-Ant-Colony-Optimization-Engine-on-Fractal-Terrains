...
double AntSystem::m_eps = 0.0;

void AntSystem::reserve(std::size_t count) {
...
void AntSystem::add_ant(const position_t& pos, std::size_t seed) {
    add_ant(pos, seed, unloaded);
}

void AntSystem::add_ant(const position_t& pos, std::size_t seed, std::uint8_t state) {
